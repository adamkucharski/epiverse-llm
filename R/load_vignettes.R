...
epiparameter_out <- read_file("data/vignettes/epiparameter_prompt.md")
...
superspreading_out <- read_file("data/vignettes/superspreading_prompt.md")

# Load serofoi vignettes
serofoi_1 <- read_file("https://raw.githubusercontent.com/epiverse-trace/serofoi/main/vignettes/serofoi.Rmd")
...
finalsize_out <- read_file("data/vignettes/finalsize_prompt.md")


# Load linelist vignettes
linelist_1 <- read_file("https://raw.githubusercontent.com/epiverse-trace/linelist/main/vignettes/linelist.Rmd")
